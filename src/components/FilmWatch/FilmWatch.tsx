...
import { embedMovie, embedTV } from "../../shared/utils.ts";
import { useAppSelector } from "../../store/hooks.ts";
import ReadMore from "../Common/ReadMore.tsx";
import RightbarFilms from "../Common/RightbarFilms.tsx";
import SearchBox from "../Common/SearchBox.tsx";
import Sidebar from "../Common/Sidebar.tsx";
import SidebarMini from "../Common/SidebarMini.tsx";
import Skeleton from "../Common/Skeleton.tsx";
import Title from "../Common/Title.tsx";
import Footer from "../Footer/Footer.tsx";
import Comment from "./Comment/Comment.tsx";
import SeasonSelection from "./SeasonSelection.tsx";
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="shrink-0 md:max-w-[250px] w-full relative px-6">
          {!isMobile && <SearchBox />}
          {media_type === "movie" && (
            <RightbarFilms
