...
import { Cast, DetailMovie, DetailTV, Reviews } from "../../shared/types.ts";
import { resizeImage } from "../../shared/utils.ts";
          ...
          >
            <button
              ...
              className={`hover:text-white transition duration-300 pb-1 ${
                currentTab === btnName &&
                "font-normal -translate-y-2 border-b-2 border-primary text-white"
              }`}
            >
      ...
      <div className="mt-10 text-sm">
        {currentTab === "overall" && (
          <>
            ...
            <p className="text-white font-normal  mb-3">STORY</p>
            {detail && (
            ...
            <p className="text-white font-normal mt-8 mb-3">DETAILS</p>
            {!detail && (
              <>
