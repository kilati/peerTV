...
import { getExploreMovie, getExploreTV } from "../../services/explore.ts";
import { ConfigType, ItemsPage } from "../../shared/types.ts";
import ExploreResultContent from "./ExploreResultContent.tsx";
